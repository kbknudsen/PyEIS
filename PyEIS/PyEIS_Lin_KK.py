...
def KK_timeconst(w, num_RC):
    ...
    for j in range(len(num_RC)):
        ...
        t_initial.append(
            ...
            ** (
                (np.log10(t_min))
                + (j - 1) / (len(num_RC) - 1) * np.log10(t_max / t_min)
            )
...
def KK_errorfunc_2(w, re, im, num_RC, t_values):
    ...
    if num_RC == 51:
        re_fit = curve_fit(
            lambda w, Rs, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29, R30, R31, R32, R33, R34, R35, R36, R37, R38, R39, R40, R41, R42, R43, R44, R45, R46, R47, R48, R49, R50, R51: KK_RC51_fit(
                w,
                Rs,
                R1,
                R2,
